...
public final class CuisineInternalGateway implements CuisineAPI
{
    ...
    public static void init()
    {
        ...
        Arrays.asList(
                ...
                MaterialBuilder.of("water").rawColor(0x55DDDDFF).saturation(-0.1f).form(Form.JUICE).build(),
                MaterialBuilder.of("milk").rawColor(0xCCFFFFFF).saturation(-0.1f).category(MaterialCategory.PROTEIN).form(Form.JUICE).build(),
