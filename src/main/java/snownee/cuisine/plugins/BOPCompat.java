...
public class BOPCompat implements IModule
{
    ...
    public void init()
    {
        ...
        if (CuisineConfig.GENERAL.axeChopping)
        {
            ...
            {
                Processing.CHOPPING.add(new Chopping(new ResourceLocation(MODID, "sacred_oak"), ItemDefinition.of(log, 4), new ItemStack(planks, 6, 0)));
                Processing.CHOPPING.add(new Chopping(new ResourceLocation(MODID, "cherry"), ItemDefinition.of(log, 5), new ItemStack(planks, 6, 1)));
                Processing.CHOPPING.add(new Chopping(new ResourceLocation(MODID, "umbran"), ItemDefinition.of(log, 6), new ItemStack(planks, 6, 2)));
                Processing.CHOPPING.add(new Chopping(new ResourceLocation(MODID, "fir"), ItemDefinition.of(log, 7), new ItemStack(planks, 6, 3)));
            }
            log = ForgeRegistries.ITEMS.getValue(new ResourceLocation(MODID, "log_1"));
            if (log != null && planks != null)
            {
                Processing.CHOPPING.add(new Chopping(new ResourceLocation(MODID, "ethereal"), ItemDefinition.of(log, 4), new ItemStack(planks, 6, 4)));
                Processing.CHOPPING.add(new Chopping(new ResourceLocation(MODID, "magic"), ItemDefinition.of(log, 5), new ItemStack(planks, 6, 5)));
                Processing.CHOPPING.add(new Chopping(new ResourceLocation(MODID, "mangrove"), ItemDefinition.of(log, 6), new ItemStack(planks, 6, 6)));
                Processing.CHOPPING.add(new Chopping(new ResourceLocation(MODID, "palm"), ItemDefinition.of(log, 7), new ItemStack(planks, 6, 7)));
            }
            log = ForgeRegistries.ITEMS.getValue(new ResourceLocation(MODID, "log_2"));
            if (log != null && planks != null)
            {
                Processing.CHOPPING.add(new Chopping(new ResourceLocation(MODID, "redwood"), ItemDefinition.of(log, 4), new ItemStack(planks, 6, 8)));
                Processing.CHOPPING.add(new Chopping(new ResourceLocation(MODID, "willow"), ItemDefinition.of(log, 5), new ItemStack(planks, 6, 9)));
                Processing.CHOPPING.add(new Chopping(new ResourceLocation(MODID, "pine"), ItemDefinition.of(log, 6), new ItemStack(planks, 6, 10)));
                Processing.CHOPPING.add(new Chopping(new ResourceLocation(MODID, "hellbark"), ItemDefinition.of(log, 7), new ItemStack(planks, 6, 11)));
            }
            log = ForgeRegistries.ITEMS.getValue(new ResourceLocation(MODID, "log_3"));
            if (log != null && planks != null)
            {
                Processing.CHOPPING.add(new Chopping(new ResourceLocation(MODID, "jacaranda"), ItemDefinition.of(log, 4), new ItemStack(planks, 6, 12)));
                Processing.CHOPPING.add(new Chopping(new ResourceLocation(MODID, "mahogany"), ItemDefinition.of(log, 5), new ItemStack(planks, 6, 13)));
                Processing.CHOPPING.add(new Chopping(new ResourceLocation(MODID, "ebony"), ItemDefinition.of(log, 6), new ItemStack(planks, 6, 14)));
                Processing.CHOPPING.add(new Chopping(new ResourceLocation(MODID, "eucalyptus"), ItemDefinition.of(log, 7), new ItemStack(planks, 6, 15)));
            }
        }
    }
}
