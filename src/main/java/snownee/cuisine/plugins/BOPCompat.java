...
public class BOPCompat implements IModule
{
    ...
    public void init()
    {
        ...
        CuisineInternalGateway.INSTANCE.oreDictToMaterialMapping.put("cropKelp", kelp);
        ...
        CuisineInternalGateway.INSTANCE.oreDictToMaterialMapping.put("cropPear", pear);
        ...
        CuisineInternalGateway.INSTANCE.oreDictToMaterialMapping.put("cropPeach", peach);
        ...
        CuisineInternalGateway.INSTANCE.oreDictToMaterialMapping.put("cropPersimmon", persimmon);
        ...
        if (itemBerry != null)
        {
            ...
            CuisineInternalGateway.INSTANCE.itemToMaterialMapping.put(ItemDefinition.of(itemBerry), wildberry);
        }
