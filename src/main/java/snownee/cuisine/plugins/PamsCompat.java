...
public class PamsCompat implements IModule
{
    ...
    public void init()
    {
        ...
        Material pawpaw = CulinaryHub.API_INSTANCE.register(new SimpleMaterialImpl("pawpaw", 0x91bb69, 0, 0, 0, 0, 0, MaterialCategory.FRUIT).setValidForms(Form.JUICE_ONLY));
        Helper.registerMaterial(pawpaw, "harvestcraft:pawpawitem");
        Material soursop = CulinaryHub.API_INSTANCE.register(new SimpleMaterialImpl("soursop", 0x8bc34b, 0, 0, 0, 0, 0, MaterialCategory.FRUIT).setValidForms(Form.JUICE_ONLY));
        Helper.registerMaterial(soursop, "harvestcraft:soursopitem");
        Material guava = CulinaryHub.API_INSTANCE.register(new SimpleMaterialImpl("guava", 0x558d30, 0, 0, 0, 0, 0, MaterialCategory.FRUIT).setValidForms(Form.JUICE_ONLY));
        Helper.registerMaterial(guava, "harvestcraft:guavaitem");
        Material lychee = CulinaryHub.API_INSTANCE.register(new SimpleMaterialImpl("lychee", 0xab2323, 0, 0, 0, 0, 0, MaterialCategory.FRUIT).setValidForms(Form.JUICE_ONLY));
        Helper.registerMaterial(lychee, "harvestcraft:lycheeitem");
        Material passion_fruit = CulinaryHub.API_INSTANCE.register(new SimpleMaterialImpl("passion_fruit", 0x5b3a43, 0, 0, 0, 0, 0, MaterialCategory.FRUIT).setValidForms(Form.JUICE_ONLY));
        Helper.registerMaterial(passion_fruit, "harvestcraft:passionfruititem");
        Material rambutan = CulinaryHub.API_INSTANCE.register(new SimpleMaterialImpl("rambutan", 0xa31b1b, 0, 0, 0, 0, 0, MaterialCategory.FRUIT).setValidForms(Form.JUICE_ONLY));
        Helper.registerMaterial(rambutan, "harvestcraft:rambutanitem");
    }
